...
for lane_id in lanes.lane_ids:
    ...
    if not successors:
        ...
        for successor in successors:
            ...
            ref_point, connection_points_1, connection_points_2 = lanes.determine_connnection_points(lane_id, ref_lane_end, successor)
...
lane_connections = pd.DataFrame(columns = ['connector_id' , 'intersection_id', 'connection_line'])
